...
if __name__ == "__main__":
  ...
  model_LoanModelExtraWithDropout2 = LoanModelExtraWithDropout(config["hidden_size"],
                                    config["num_blocks"],
                                    config["p"])

  history5 = train(
    model=model_LoanModelExtraWithDropout2,
    train_dataset=train_dataset,
    eval_dataset=val_dataset,
    config=config,
  )

  model_LoanModelExtraWithDropout2.load_state_dict(torch.load("model.pt"))
